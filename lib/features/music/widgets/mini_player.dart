    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(track.title, style: const TextStyle(color: MusicColors.text, fontWeight: FontWeight.w600)), Text(track.artist, style: const TextStyle(color: MusicColors.text2, fontSize: 12))])),
