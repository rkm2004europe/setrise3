...
class ScheduleLiveScreen extends StatefulWidget {
  const ScheduleLiveScreen({super.key});

  @override
  State<ScheduleLiveScreen> createState() => _ScheduleLiveScreenState();
}

class _ScheduleLiveScreenState extends State<ScheduleLiveScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildField('عنوان البث', _titleCtrl),
  ...
  Widget _buildTopBar(BuildContext context) => Row(children: [
    ...
    const Text('جدولة بث', style: TextStyle(color: LiveColors.text, fontSize: 20, fontWeight: FontWeight.w800)),
  ]);
}
