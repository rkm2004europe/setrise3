...
class LiveShopIntegrationScreen extends StatelessWidget {
  const LiveShopIntegrationScreen({super.key});
  ...
  Widget _buildTopBar(BuildContext context) => Padding(
    ...
    child: Row(children: [
      ...
      const Text('المتجر', style: TextStyle(color: LiveColors.text, fontSize: 20, fontWeight: FontWeight.w800)),
    ]),
  );
}
