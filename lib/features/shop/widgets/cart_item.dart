...
//
// عنصر داخل قائمة سلة التسوق — مع أزرار +/-/حذف
//
// الإصلاحات:
//   - إضافة أزرار للتحكم في الكمية (+/-) والحذف
//   - حماية الوصول لـ images[0] بفحص isEmpty
//   - استخدام CartService لإدارة الكمية
...
class CartItemWidget extends StatelessWidget {
  ...
  final VoidCallback? onChanged; // استدعاء بعد أي تغيير لإعادة بناء الشاشة
