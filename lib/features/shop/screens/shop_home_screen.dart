...
//
// الإصلاحات:
//   - ربط المنتجات بـ ShopController (مع حالة تحميل)
//   - إضافة أزرار للوصول لقائمة الأمنيات والمزادات والطلبات
//   - ربط كل قسم بشاشة CategoryScreen المناسبة
//   - عرض مؤشر تحميل أثناء جلب المنتجات
//   - استخدام WishlistController لعرض عدد العناصر على الأيقونة
            ...
            children: [
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (_) => const SearchShopScreen()),
                      ),
                    ),
                    Stack(
                      children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    _quickAction(
                        context, Icons.history, 'طلباتي', ShopColors.accent, () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    _quickAction(context, Icons.gavel, 'المزادات',
                        ShopColors.gold, () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    const SizedBox(width: 10),
                    _quickAction(context, Icons.storefront, 'السوق المفتوح',
                        ShopColors.green, () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                    ...
                    return GestureDetector(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(cat['name']!,
                              style: const TextStyle(
                                  color: ShopColors.text2, fontSize: 11)),
                        ],
                      ),
                    );
                  },
              ...
              if (_shopCtrl.isLoading)
                ...
                GridView.builder(
                  ...
                  itemCount: _shopCtrl.products.isNotEmpty
                      ? _shopCtrl.products.length
                      : mockProducts.length,
                  itemBuilder: (_, i) => ProductCard(
                    product: _shopCtrl.products.isNotEmpty
                        ? _shopCtrl.products[i]
                        : mockProducts[i],
                  ),
                ),
